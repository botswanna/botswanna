    ...
    <div class="chat-header">
      ...
      <div class="chat-close">
        <img
          ...
          src="https://botswanna.dev/assets/img/chat-close-icon.svg"
    ...
    <div class="input-box">
      ...
      <div class="input-submit">
        <img
          ...
          src="https://botswanna.dev/assets/img/input-submit-icon.svg"
...
const Botswanna = Vue.extend({
  props: {
    ...
    iconURL: {
      type: String,
      default: 'https://botswanna.dev/assets/img/botswanna-icon.svg',
    },
    display: {
      type: Boolean,
      default: false,
